            ...
            <>
              ...
              {backups.length > 5 && (
                <p className="text-sm text-muted-foreground mt-4 text-center">
                  Tüm yedekleri görmek için <a href="/backup-management" className="text-primary hover:underline">Yedekleme Yönetimi</a> sayfasını ziyaret edin.
                </p>
              )}
            </>
          )}
            ...
            <AlertDialogDescription className="space-y-3">
              ...
              <div className="mt-4 p-4 border-2 border-dashed rounded-lg">
                <input
                  ...
                  className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-primary-foreground hover:file:bg-primary/90 file:cursor-pointer"
                  disabled={uploading}
                />
                {selectedFile && (
