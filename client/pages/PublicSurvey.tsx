      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50/50 flex items-center justify-center p-4">
        <Card className="w-full max-w-md border-border/40 shadow-lg">
          ...
          <CardContent className="text-center space-y-6">
            ...
            <Button onClick={() => navigate('/')} variant="outline" className="gap-2 shadow-sm hover:shadow transition-shadow">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              {currentQuestionIndex === questions.length - 1 ? (
                <Button
                  ...
                  className="gap-2 bg-emerald-600 hover:bg-emerald-700 shadow-sm hover:shadow-md transition-all"
                >
                  {isSubmitting ? (
                    <>
