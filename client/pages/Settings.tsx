            ...
            <div className="flex flex-col sm:flex-row items-center justify-between bg-card/95 backdrop-blur-md border-2 border-border/80 rounded-xl shadow-2xl p-3 sm:p-4 gap-3 sm:gap-4">
              ...
              <div className="flex gap-2 w-full sm:w-auto justify-end">
                <Button
                  ...
                  onClick={() => form.reset()}
                  disabled={isSaving}
                  className="flex-1 sm:flex-none min-w-[100px] transition-all duration-200 hover:scale-105"
                >
                  İptal
                </Button>
                <Button
                  ...
                  disabled={isSaving}
                  className="flex-1 sm:flex-none min-w-[140px] gap-2 bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg transition-all duration-200 hover:scale-105"
                >
                  {isSaving ? (
                    <>
