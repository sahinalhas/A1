            ...
            <button
              ...
              className={`
                ...
                ${isSelected 
                  ...
                  : 'bg-card hover:bg-accent/50 border-2 border-border hover:border-primary/30 shadow-sm hover:shadow-md hover:scale-102'
                }
              `}
            >
  ...
  if (!isAdding) {
    return (
      <Button
        variant="outline"
        size="lg"
        className="w-full h-14 border-2 border-dashed border-primary/30 hover:border-primary hover:bg-primary/5 transition-all duration-300"
...
function SubjectAccordion({
  ...
  return (
    <div className="border-2 rounded-xl bg-card overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
    ...
    <div className="p-4 space-y-3">
      ...
      {isAdding ? (
        ...
        <Button
          variant="outline"
          size="sm"
          className="w-full h-9 border-2 border-dashed border-primary/30 hover:border-primary hover:bg-primary/5 text-xs"
          onClick={() => setIsAdding(true)}
        >
...
function TopicRow({
  ...
  return (
    <div className="grid grid-cols-12 gap-2 px-3 py-2 hover:bg-accent/50 rounded-md transition-all duration-200 group border border-transparent hover:border-primary/20">
      ...
      <div className="col-span-1 flex items-center justify-end gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <Button variant="ghost" size="sm" onClick={handleDelete} className="h-7 w-7 p-0 hover:bg-destructive/10 hover:text-destructive">
